...
public:
    ...
    /** Occurs when the raw audio data is received. If you set \ref agora::recording::RecordingConfig::decodeAudio "decodeAudio" in \ref agora::recording::RecordingConfig "RecordingConfig" as `1`, `2`, or `3`, you receive audio frames from this callback.
     *
     * @param uid The user ID.
     ...
     *
     * If you set \ref agora::recording::RecordingConfig::decodeVideo "decodeVideo" in \ref agora::recording::RecordingConfig "RecordingConfig" as `1`, `2`, or `3`, you receive raw video data from this callback.
     *
     * If you set \ref agora::recording::RecordingConfig::decodeVideo "decodeVideo" in \ref agora::recording::RecordingConfig "RecordingConfig" as `4` or `5`, you receive video frames in JPG file format from this callback.
     *
     ...
     *
     * @param uid The user ID.
     * @param frame The received video frame in YUV, H.264, H.265, JPG, or JPG file format. For more information, see \ref agora::linuxsdk::VideoFrame "VideoFrame".
     */
...
typedef struct RecordingConfig {
    ...
    /** Sets the audio decoding format. For more information, see \ref agora::linuxsdk::AUDIO_FORMAT_TYPE "AUDIO_FORMAT_TYPE".
     ...
     @note When \ref agora::linuxsdk::AUDIO_FORMAT_TYPE "AUDIO_FORMAT_TYPE" = 1 or 2, \ref agora::recording::RecordingConfig#isMixingEnabled "isMixingEnabled" cannot be set as true.
     */
