...
class AgoraSdk : virtual public agora::recording::IRecordingEngineEventHandler {
    public:
        ...
        virtual int updateSubscribeVideoUids(agora::linuxsdk::uid_t *uids, uint32_t num);
        virtual int updateSubscribeAudioUids(agora::linuxsdk::uid_t *uids, uint32_t num);
        virtual uint32_t getUidByUserAccount(const char *userAccount);
        virtual uint32_t getUserAccountByUid(agora::linuxsdk::uid_t uid, char* userAccountBuf, uint32_t buf_len);
    ...
    protected:
        ...
        virtual void audioFrameReceived(agora::linuxsdk::uid_t uid, const agora::linuxsdk::AudioFrame *frame) const {
            audioFrameReceivedImpl(uid, frame);
        }
        virtual void videoFrameReceived(agora::linuxsdk::uid_t uid, const agora::linuxsdk::VideoFrame *frame) const {
            videoFrameReceivedImpl(uid, frame);
        }
        virtual void onActiveSpeaker(agora::linuxsdk::uid_t uid) {
        ...
        virtual void onFirstRemoteVideoDecoded(agora::linuxsdk::uid_t uid, int width, int height, int elapsed) {
          onFirstRemoteVideoDecodedImpl(uid, width, height, elapsed);
        }

        virtual void onFirstRemoteAudioFrame(agora::linuxsdk::uid_t uid, int elapsed) {
        ...
        virtual void onRejoinChannelSuccess(const char* channelId, agora::linuxsdk::uid_t uid) ;
        ...
        virtual void onLocalUserRegistered(agora::linuxsdk::uid_t uid, const char* userAccount);

        virtual void onUserInfoUpdated(agora::linuxsdk::uid_t uid, const agora::linuxsdk::UserInfo& info);
    ...
    protected:
        ...
        void onActiveSpeakerImpl(agora::linuxsdk::uid_t uid);

        void onAudioVolumeIndicationImpl(const agora::linuxsdk::AudioVolumeInfo* speakers, unsigned int speakerNum);

        void onFirstRemoteVideoDecodedImpl(agora::linuxsdk::uid_t uid, int width, int height, int elapsed);
        void onFirstRemoteAudioFrameImpl(agora::linuxsdk::uid_t uid, int elapsed);
    ...
    protected:
        ...
        std::unordered_set<agora::linuxsdk::uid_t> m_subscribedVideoUids;
        std::unordered_set<agora::linuxsdk::uid_t> m_subscribedAudioUids;
