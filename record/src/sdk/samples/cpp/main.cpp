...
int main(int argc, char * const argv[]) {
  ...
  string videoBg = "";
  string userBg = "";
  //int isAudioUidWhiteList = 1;
  //int isVideoUidWhiteList = 1;
  ...
  parser.add_long_opt("mixedVideoAudio", &mixedVideoAudio, "mixVideoAudio:(0:seperated Audio,Video) (1:mixed Audio & Video with legacy codec) (2:mixed Audio & Video with new codec) (4:output seperated Audio,Video TS files) (5:output seperated Audio,Video TS and MP4 files) (6:output mixed Audio & Video TS files) (7:output mixed Audio & Video TS and MP4 files) default is 0 /option");
  ...
  //parser.add_long_opt("isVideoUidWhiteList", &isVideoUidWhiteList, "video uids blacklist or whitelist/option");
  //parser.add_long_opt("isAudioUidWhiteList", &isAudioUidWhiteList, "audio uids blacklist or whitelist/option");
  parser.add_long_opt("subscribeVideoUids", &subscribeVideoUids, "video stream of specific uids. uids seperated by commas, like 1234,2345/option");
  parser.add_long_opt("subscribeAudioUids", &subscribeAudioUids, "audio stream of specific uids. uids sperated by commas, like 1234,2345 /option");
  ...
  if (!autoSubscribe) {
    // config.audioUidListType = ( isAudioUidWhiteList ) ?
    //    agora::linuxsdk::UID_SUBSCRIBE_WHITE_LIST : agora::linuxsdk::UID_SUBSCRIBE_BLACK_LIST;
    // config.videoUidListType = ( isVideoUidWhiteList ) ?
    //    agora::linuxsdk::UID_SUBSCRIBE_WHITE_LIST : agora::linuxsdk::UID_SUBSCRIBE_BLACK_LIST;
